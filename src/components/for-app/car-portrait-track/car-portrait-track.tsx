...
interface CarPortraitTrackPropTypes {
  carId: string
}

export default class CarPortraitTrack extends Component<CarPortraitTrackPropTypes> {
  static defaultProps = {
    carId: null
  }
  ...
  async getPortraitData() {
    // Log.info('画像地图carId：', this.props.carId)
